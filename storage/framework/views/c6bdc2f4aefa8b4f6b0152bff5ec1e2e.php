    ...
    <?php $__env->startSection('menu'); ?>    
        <li><a href="/dashboard">Inicio</a></li>
            <li><a href="/registerOffer">Registrar Oferta</a></li>
            <!-- Settings Dropdown -->
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            <div><?php echo e(Auth::user()->nameCompany); ?></div>
...
<?php echo $__env->make('templetes.templete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jantonio/projectsLaravel/VercionLocalEmpleaTV2/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>
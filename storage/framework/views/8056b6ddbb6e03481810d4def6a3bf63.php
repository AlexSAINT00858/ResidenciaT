...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.danger-button','data' => ['class' => 'btn btn-primary','xData' => '','xOn:click.prevent' => '$dispatch(\'open-modal\', \'confirm-user-deletion\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn btn-primary','x-data' => '','x-on:click.prevent' => '$dispatch(\'open-modal\', \'confirm-user-deletion\')']); ?><?php echo e(__('Eliminar cuenta')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/jantonio/projectsLaravel/EMPLEATV2/resources/views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>
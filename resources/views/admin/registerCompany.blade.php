    ...
    <x-guest-layout>
        ...
        <form method="POST" action="/registerCompany" class="w-100 m-auto my-3"
            ...
            <div class="mt-4">
                ...
                <br>
                <x-text-input id="address" class="block mt-1 w-75" type="text" name="address" :value="old('address')" autofocus autocomplete="address"/>
            </div>
            ...
            <div class="mt-4">
                ...
                <br>
                <x-text-input id="phoneNumber" class="block mt-1 w-75" type="text" name="phoneNumber" :value="old('phoneNumber')" autofocus autocomplete="phoneNumber"/>

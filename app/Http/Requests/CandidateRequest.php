...
class CandidateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nameCandidate' => 'required|string|max:100',
            'lastName' => 'required|string|max:100',
            'phoneNumberCandidate' => 'required|regex:/^[0-9]{10}$/',
            'emailCandidate' => 'required|regex:/^\S+@\S+\.\S+$/',
            'jobTrade' => 'required|string|max:100',
            'resumeCandidate' => 'required'
        ];

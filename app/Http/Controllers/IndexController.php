...
class IndexController extends Controller
{
    ...
    public function show() {
        ...
        return view('welcome', ['offerts' => $offerts]);
    }

    public function showLoginCandidate($idOffer) {
        return view('index.loginCandidate', ['idOffer' => $idOffer]);
    }

    //Muestra el formulario para regiatrar una oferta de trabajo
    public function showRegisterCandidate($idOffer) {
        return view('index.registerCandidate', ['idOffer' => $idOffer]);
    }
